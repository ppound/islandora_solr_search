      ...
      <dl class="solr-grid-field">
        <dt class="solr-grid-thumb">
          <?php
            ...
            print l($image, $result['object_url'], array('html' => TRUE, 'query' => $result['object_url_params'], 'fragment' => $result['object_url_fragment']));
          ?>
        </dt>
        <dd class="solr-grid-caption">
          <?php
            $object_label = isset($result['object_label']) ? $result['object_label'] : '';
            print l($object_label, $result['object_url'], array('query' => $result['object_url_params'], 'fragment' => $result['object_url_fragment']));
          ?>
        </dd>
      </dl>
    <?php endforeach; ?>
